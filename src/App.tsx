...
const components: ComponentEntry[] = [
  ...
  { name: 'Combobox', path: 'combobox', description: 'Accessible combobox with type-to-filter autocomplete. Add the fallback-select attribute to show a native select on touch/mobile devices.' },
